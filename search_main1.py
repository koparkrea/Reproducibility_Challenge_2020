...
def main(args):
    ...
    model_base_path, model_best_path = os.path.join(os.getcwd(),'result','state_dict','search1','checkpoint.th'), os.path.join(os.getcwd(),'result','state_dict','search1', 'best.th')
    
    #network, criterion =torch.nn.DataParallel(search_model).cuda(), criterion.cuda()
    network, criterion = search_model, criterion.to(device)
    ...
    torch.save({
        ...
        }, os.path.join(os.getcwd(), 'result','loader','loader.th'))
